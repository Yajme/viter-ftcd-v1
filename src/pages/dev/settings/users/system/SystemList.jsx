...
const SystemUsersList = ({ setItemEdit, itemEdit }) => {
  ...
  const {
    ...
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `${apiVersion}/controllers/dev/settings/users/system/page.php?start=${pageParam}`,
        `${apiVersion}/controllers/dev/settings/users/system/page.php?start=${pageParam}`, // list endpoint
...
//   }, [inView]);
  ...
  return (
    <>
                  ...
                  return (
                    <tr key={key}>
                      ...
                      <td>
                        <Status
                          text={
                            item.user_is_active == 1 ? "active" : "inactive"
                          }
                        />
                      </td>
      ...
      {store.isRestore && (
        <ModalRestore
          mysqlApiRestore={`${apiVersion}/controllers/dev/settings/users/system/index.php?id=${itemEdit.user_aid}&action=archive`}
          dataItem={itemEdit}
          queryKey={"users"}
      ...
      {store.isDelete && (
        <ModalDelete
          mysqlApiDelete={`${apiVersion}/controllers/dev/settings/users/system/index.php?id=${itemEdit.user_aid}`}
          dataItem={itemEdit}
          queryKey={"users"}
      ...
      {store.isArchive && (
        <ModalArchive
          mysqlApiArchive={`${apiVersion}/controllers/dev/settings/users/system/index.php?id=${itemEdit.user_aid}&action=archive`}
          dataItem={itemEdit}
          queryKey={"users"}
