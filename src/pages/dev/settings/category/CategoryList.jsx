...
const CategoryList = ({ setItemEdit, itemEdit }) => {
  ...
  const {
    ...
    queryKey: ["category", searchValue, store.isSearch, filterData],
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `${apiVersion}/controllers/dev/settings/category/page.php?start=${pageParam}`,
        `${apiVersion}/controllers/dev/settings/category/page.php?start=${pageParam}`, // list endpoint
...
//   }, [inView]);
  ...
  return (
    <>
      ...
      {store.isRestore && (
        <ModalRestore
          mysqlApiRestore={`${apiVersion}/controllers/dev/settings/category/index.php?id=${itemEdit.category_aid}&action=archive`}
          dataItem={itemEdit}
          queryKey={"category"}
      ...
      {store.isDelete && (
        <ModalDelete
          mysqlApiDelete={`${apiVersion}/controllers/dev/settings/category/index.php?id=${itemEdit.category_aid}`}
          dataItem={itemEdit}
          queryKey={"category"}
      ...
      {store.isArchive && (
        <ModalArchive
          mysqlApiArchive={`${apiVersion}/controllers/dev/settings/category/index.php?id=${itemEdit.category_aid}&action=archive`}
          dataItem={itemEdit}
          queryKey={"category"}
