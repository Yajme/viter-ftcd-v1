...
const ModalAddCategory = ({ itemEdit , activeRoles = []}) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `${apiVersion}/controllers/dev/settings/category/index.php?id=${itemEdit.category_aid}`
  ...
  const yupSchema = Yup.object({
    category_name: Yup.string().trim().required("Name is required"),
    category_description: Yup.string().trim().required("Description is required"),
  });
